...
const EXPECTED_COMMAND_TYPES = [
  ...
  "demolishPlanetDefenseBuilding", "buildPlanetShip", "cancelShipConstruction",
  "queueArmyRecruitment", "landArmyFleet", "embarkPlanetArmies", "beginPlanetInvasion", "withdrawGroundBattle",
