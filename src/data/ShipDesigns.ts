...
export const SHIP_HULL_DEFINITIONS: Record<StarbaseShipKind, ShipHullDefinition> = {
  ...
  destroyer: {
    ...
    crewDemand: 2_400,
    cost: resources({ minerals: 360, alloys: 280 }),
    upkeep: resources({ energy: 1.8, alloys: 0.24 }),
    combat: {
      maxShield: 120,
      maxArmor: 100,
      maxHull: 260,
  ...
  cruiser: {
    ...
    speed: 0.68,
    buildDays: 38,
    alloyUpkeepPerDay: 52,
    crewDemand: 5_800,
    cost: resources({ minerals: 780, alloys: 680, goods: 80 }),
    upkeep: resources({ energy: 3.4, alloys: 0.46, goods: 0.12 }),
    combat: {
      maxShield: 260,
      maxArmor: 240,
      maxHull: 620,
  ...
  battleship: {
    ...
    speed: 0.52,
    buildDays: 80,
    alloyUpkeepPerDay: 98,
    crewDemand: 13_000,
    cost: resources({ minerals: 1_600, alloys: 1_500, goods: 180 }),
    upkeep: resources({ energy: 6.8, alloys: 0.95, goods: 0.28 }),
    combat: {
      maxShield: 580,
      maxArmor: 560,
      maxHull: 1400,
