  ...
  return (
    <main className="dev-page">
      ...
      <section className="dev-stat-grid">
        ...
        <StatTile label="Active Game" value={formatNumber(stats.game.activeConnections)} detail={`${stats.activity.activeAuthSessions} active auth sessions`} tone={stats.game.online ? 'good' : 'warn'} />
      </section>
